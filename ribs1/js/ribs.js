jQuery.fn.ribs = function(data) {
    var My = {
         ...
         *lx : [ {
            ...
            type : 'yh',
            name : 'bank account',//银行
            color : '#84DDDE',
            icon : ''
        }, {
            type : 'td',
            name : 'land use certificate',//土地
            color : '#84DDDE',
            icon : ''
        }, {
            type : 'swGs',
...
//        var title = $("<div class='title clearfix'></div>");
        // 3 上一页
        var prev = $("<div class='hd'><span class='title'>已被控制财产</span><a class='prev'></a><span  class='title'>未被控制财产</span></div>");
        // 4 内容 自动生成
        ...
        $.each(data, function(i) {
            ...
            var nameSpan = $("<span class='name'/>").append(
                    "<span class='text text-overflow-fag'>" +i+". "+ name + "</span>");
